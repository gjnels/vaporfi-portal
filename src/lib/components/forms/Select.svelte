...
<label class={twMerge('group flex flex-col gap-0.5', containerStyles)}>
  ...
  <select
    {name}
    class={twMerge(
      'cursor-pointer rounded-lg border-2 border-transparent bg-zinc-800 px-3 py-2 text-white outline-none transition focus:border-white focus:bg-zinc-900 focus:ring-0',
