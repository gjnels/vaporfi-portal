...
<label class={twMerge('group flex flex-col gap-0.5', containerStyles)}>
  ...
  <select
    {name}
    class={twMerge(
      'cursor-pointer rounded-lg border-[3px] border-transparent bg-zinc-800 px-3 py-2 text-white outline-none transition focus:border-zinc-300 focus:bg-transparent focus:ring-0',
