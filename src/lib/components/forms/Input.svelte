...
<label class={twMerge('group flex flex-col', containerStyles)}>
  ...
  <input
    ...
    {name}
    class={twMerge(
      'rounded-lg border-[3px] border-transparent bg-zinc-800 px-3 py-2 text-white placeholder-zinc-400 outline-none transition focus:border-zinc-300 focus:bg-transparent focus:ring-0',
