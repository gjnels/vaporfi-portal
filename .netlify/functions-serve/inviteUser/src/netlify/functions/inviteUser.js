...
var require_main6 = __commonJS({
  "node_modules/@supabase/supabase-js/dist/main/index.js"(exports) {
    ...
    __exportStar(require_main5(), exports);
    var functions_js_1 = require_main();
    Object.defineProperty(exports, "FunctionsHttpError", { enumerable: true, get: function() {
...
// netlify/functions/inviteUser.js
var inviteUser_exports = {};
__export(inviteUser_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(inviteUser_exports);
var { createClient } = require_main6();
var supabase = createClient(process.env.VITE_SUPABASE_API_URL, process.env.SUPABASE_SERVICE_ROLE_KEY);
